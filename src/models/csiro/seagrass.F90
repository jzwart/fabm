...
module csiro_seagrass
   ...
   type,extends(type_particle_model),public :: type_csiro_seagrass
      ...
      type (type_horizontal_dependency_id) :: id_N, id_P
...
contains
   ...
   subroutine do_bottom(self,_ARGUMENTS_DO_BOTTOM_)
      ...
      _GET_HORIZONTAL_(self%id_SG_A,SG_A)    ! leaf biomass in g N m-2
      _GET_HORIZONTAL_(self%id_SG_B,SG_B)    ! root biomass in g N m-2
      _GET_HORIZONTAL_(self%id_N,N)          ! porewater DIN in mmol m-3
      _GET_HORIZONTAL_(self%id_P,P)          ! porewater DIP in mmol m-3
      _GET_HORIZONTAL_(self%id_E_par,E_par)  ! PAR at top of canopy in W m-2
      ...
      _SET_BOTTOM_ODE_(self%id_N_source,         -1._rk/M_N*mu_SG_A*SG_A/86400._rk*1000._rk)  ! in mmol m-2 s-1
      _SET_BOTTOM_ODE_(self%id_P_source,  -1._rk/N_to_P/M_N*mu_SG_A*SG_A/86400._rk*1000._rk)  ! in mmol m-2 s-1
      _SET_BOTTOM_EXCHANGE_(self%id_DIC, -C_to_P/N_to_P/M_N*mu_SG_A*SG_A/86400._rk*1000._rk)  ! in mmol m-2 s-1
      _SET_BOTTOM_EXCHANGE_(self%id_O2,  O2_to_P/N_to_P/M_N*mu_SG_A*SG_A/86400._rk*1000._rk)  ! in mmol O2 m-2 s-1
      _SET_BOTTOM_ODE_(self%id_SG_A,(mu_SG_A*SG_A - T_fac*self%zeta_SG_A*(SG_A-self%f_seed/self%Omega_SG*(1.0_rk-self%f_below)) - Tau)/86400._rk)
      _SET_BOTTOM_ODE_(self%id_SG_B,(             - T_fac*self%zeta_SG_B*(SG_B-self%f_seed/self%Omega_SG*self%f_below         ) + Tau)/86400._rk)
      ...
      _SET_BOTTOM_EXCHANGE_(self%id_D_A_N,              dD_A_N)
      _SET_BOTTOM_EXCHANGE_(self%id_D_A_P, 1._rk/N_to_P*dD_A_N)
      _SET_BOTTOM_EXCHANGE_(self%id_D_A_C,C_to_P/N_to_P*dD_A_N)
      _SET_BOTTOM_ODE_(self%id_D_B_N,                   dD_B_N)
      _SET_BOTTOM_ODE_(self%id_D_B_P,      1._rk/N_to_P*dD_B_N)
      _SET_BOTTOM_ODE_(self%id_D_B_C,     C_to_P/N_to_P*dD_B_N)
